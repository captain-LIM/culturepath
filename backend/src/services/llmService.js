...
const MOCK_RESPONSES = {
  ...
  강릉: '강릉 감성 책방 코스를 추천드려요! Day 1은 책방 나다 → 안목해변 커피거리로 오전을 채우고, Day 2는 오죽헌에서 문학 감성을 느껴보세요. 안목해변 커피거리는 약 50개 카페가 몰려 있어 산책하기 좋습니다.',
  전주: '전주 전통 문화 코스입니다. Day 1은 한옥마을 → 경암책방으로 오전 탐방, Day 2는 전주 막걸리 골목에서 점심과 전통주 체험을 추천드려요. 한옥마을에서 도보 5분 거리라 이동도 편해요!',
  통영: '통영 문학·음악 기행 코스예요. Day 1은 박경리기념관 → 청마문학관으로 문학 감성 충전, Day 2는 통영국제음악당 → 통영 중앙시장 순서로 하루를 마무리하세요. 통영은 작지만 볼거리가 밀집해 있어요.',
};
