...
CREATE TABLE IF NOT EXISTS account_deletion_requests (
  ...
  token_nonce               VARBINARY(32) DEFAULT NULL,
  ...
  delivery_status           ENUM('pending', 'processing', 'sent', 'failed') NOT NULL DEFAULT 'sent',
  delivery_attempts         TINYINT UNSIGNED NOT NULL DEFAULT 0,
  next_delivery_attempt_at  DATETIME DEFAULT NULL,
  delivery_claimed_at       DATETIME DEFAULT NULL,
  delivery_claim_id         CHAR(36) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  last_delivery_error_code  VARCHAR(80) DEFAULT NULL,
  created_at                TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  INDEX idx_account_deletion_delivery (delivery_status, next_delivery_attempt_at, delivery_claimed_at),
