...
| 3 | R14 | **다음 황찬우 작업** | Figma Make 정보구조·P0 디자인 확정 | R11·R12의 실제 데이터 상태 |
...
## 7. R14 — Figma Make 정보구조·P0 디자인 확정

### 목표

R11·R12의 실제 데이터 상태를 기준으로 화면 구조와 시각 언어를 확정하고, Figma Make 산출물을 사람이 설계한 제품처럼 검수한다.
...
```text
황찬우: R11·R12 완료 → R14 Figma P0 → R15 Flutter 디자인 QA
                                      ↓
...
- R11 문화별 관광지 관련도와 R12 이미지·상세·연관 장소 수직 연결은 머지 완료됐다. 다음 황찬우 구현 단위는 **R14 — Figma Make 정보구조·P0 디자인**이다.
